...
class RealScannerCiLaneTests(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.real_scanner_workflow = cls.repo_root / '.github' / 'workflows' / 'libro-wcag-real-scanner.yml'
    ...
    def test_real_scanner_workflow_defines_required_gate_contract(self) -> None:
        ...
        self.assertIn('name: libro-wcag-real-scanner', content)
        self.assertIn('pull_request:', content)
        self.assertIn('workflow_dispatch:', content)
        self.assertIn('libro-wcag-real-scanner:', content)
