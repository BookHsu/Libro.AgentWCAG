...
If the GitHub Release already contains the packaged assets, the shortest published-version install path is:
...
- Repo admin setup for release assets and PR-rule bypass is documented in `docs/release/repo-admin-setup.md`.
